  ...
  render() {
    ...
    return (
      <TouchableHighlight
        ...
        style={[large ? styles.pointButtonLarge : styles.pointButtonSmall,
          { backgroundColor: color }]}
        disabled={disabled}
      >
        <Text style={[large ? styles.pointButtonTextLarge : styles.pointButtonTextSmall,
          { color: textColor }]}
        >{number}
        </Text>
      </TouchableHighlight>
